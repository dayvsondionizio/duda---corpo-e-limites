...
export const BODY_PARTS: BodyPart[] = [
  ...
  { id:'olho',       label:'Olho',           difficulty:'basico',        description:'Para ver as cores do mundo.',                                                                                  x:50, y:19 },
  { id:'boca',       label:'Boca',           difficulty:'basico',        description:'Uso minha boca para falar, comer e sorrir!',                                                                  x:50, y:26 },
  { id:'pescoco',    label:'Pescoço',        difficulty:'intermediario', description:'O pescoço segura minha cabeça e me ajuda a olhar para os lados.',                                              x:50, y:30 },
  { id:'ombro',      label:'Ombro',          difficulty:'basico',        description:'Onde apoiamos nossa mochila.',                                                                                 x:34, y:34 },
  { id:'peito',      label:'Peito',          difficulty:'basico',        description:'Onde sentimos nosso coração bater. É uma parte que fica protegida pela roupa.', isPrivate:true,               x:50, y:40 },
  { id:'barriga',    label:'Barriga',        difficulty:'basico',        description:'Onde a comida vai e onde fica o nosso umbigo.',                                                               x:50, y:49 },
  { id:'braco',      label:'Braço',          difficulty:'basico',        description:'Para brincar e dar abraços.',                                                                                 x:24, y:47 },
  { id:'cotovelo',   label:'Cotovelo',       difficulty:'intermediario', description:'A dobrinha do braço.',                                                                                        x:23, y:48 },
  { id:'pulso',      label:'Pulso',          difficulty:'avancado',      description:'Onde o relógio fica.',                                                                                        x:24, y:53 },
  { id:'mao',        label:'Mão',            difficulty:'basico',        description:'Para fazer carinho e criar coisas.',                                                                          x:24, y:56 },
  { id:'dedos',      label:'Dedos',          difficulty:'intermediario', description:'Pequenos ajudantes das mãos.',                                                                                x:24, y:59 },
  { id:'cintura',    label:'Cintura',        difficulty:'avancado',      description:'Onde seguramos a calça.',                                                                                     x:50, y:51 },
  ...
  { id:'pernas',     label:'Pernas',         difficulty:'basico',        description:'Fortes para nos fazer correr e pular.',                                                                       x:43, y:82 },
  { id:'coxas',      label:'Coxas',          difficulty:'intermediario', description:'A parte de cima das nossas pernas.',                                                                          x:43, y:65 },
  { id:'joelho',     label:'Joelho',         difficulty:'intermediario', description:'A dobrinha da perna.',                                                                                        x:43, y:74 },
  { id:'tornozelo',  label:'Tornozelo',      difficulty:'avancado',      description:'Perto do pé.',                                                                                               x:43, y:91 },
  { id:'pe',         label:'Pé',             difficulty:'basico',        description:'Nos leva para todos os lugares.',                                                                             x:43, y:95 },
  { id:'costas',     label:'Costas',         difficulty:'intermediario', description:'A parte de trás do corpo.',                                                               isBack:true,        x:50, y:40 },
...
export const AAC_CATEGORIES = [
  { id:'basic', label:'Básico', icon:'💬', items:[
    ...
    { id:'desculpe', label:'Desculpe', icon:'🥺' },
    { id:'gostei', label:'Gostei', icon:'👍' },
    { id:'nao gostei', label:'Não gostei', icon:'👎' },
    { id:'quero', label:'Quero', icon:'👉' },
    { id:'preciso', label:'Preciso', icon:'👈' },
  ]},
  { id:'needs', label:'Necessidades', icon:'🆘', items:[
    ...
    { id:'frio', label:'Frio', icon:'❄️' },
    { id:'calor', label:'Calor', icon:'☀️' },
    { id:'remedio', label:'Remédio', icon:'💊' },
  ...
  { id:'emotions', label:'Emoções', icon:'😊', items:[
    ...
    { id:'nervoso', label:'Nervoso', icon:'😰' },
    { id:'cansado', label:'Cansado', icon:'🥱' },
    { id:'machucado', label:'Machucado', icon:'🩹' },
    { id:'desconforto', label:'Desconforto', icon:'😣' },
  ]},
  { id:'people', label:'Pessoas', icon:'👪', items:[
    { id:'eu', label:'Eu', icon:'🧑' },
    { id:'voce', label:'Você', icon:'👉' },
    { id:'mamae', label:'Mamãe', icon:'👩' },
    { id:'papai', label:'Papai', icon:'👨' },
    { id:'vovo_f', label:'Vovó', icon:'👵' },
    { id:'vovo_m', label:'Vovô', icon:'👴' },
    { id:'professora', label:'Professora', icon:'👩‍🏫' },
    { id:'terapeuta', label:'Terapeuta', icon:'👩‍⚕️' },
    { id:'amigo', label:'Amigo', icon:'🧑‍🤝‍🧑' },
    { id:'irmao', label:'Irmão', icon:'👦' },
    { id:'irma', label:'Irmã', icon:'👧' },
  ]},
  { id:'actions', label:'Ações', icon:'🏃', items:[
    ...
    { id:'beber', label:'Beber', icon:'🥛' },
    { id:'ir', label:'Ir', icon:'🚶' },
    { id:'sair', label:'Sair', icon:'🚪' },
    { id:'abracar', label:'Abraçar', icon:'🤗' },
  ]},
  { id:'things', label:'Coisas', icon:'🎈', items:[
    { id:'bola', label:'Bola', icon:'⚽' },
    { id:'carrinho', label:'Carrinho', icon:'🚗' },
    { id:'boneca', label:'Boneca', icon:'🪆' },
    { id:'bloco', label:'Blocos', icon:'🧱' },
    { id:'tablet', label:'Tablet', icon:'📱' },
    { id:'desenho', label:'Desenho', icon:'🎨' },
    { id:'livro', label:'Livro', icon:'📖' },
    { id:'massinha', label:'Massinha', icon:'🏺' },
  ]},
  { id:'places', label:'Lugares', icon:'🏠', items:[
    { id:'casa', label:'Casa', icon:'🏠' },
    { id:'escola', label:'Escola', icon:'🏫' },
    { id:'parque', label:'Parque', icon:'🛝' },
    { id:'consultorio', label:'Consultório', icon:'🏥' },
    { id:'quarto', label:'Quarto', icon:'🛏️' },
    { id:'cozinha', label:'Cozinha', icon:'🍳' },
  ]},
  { id:'descriptors', label:'Cores & Números', icon:'🎨', items:[
    { id:'grande', label:'Grande', icon:'🐘' },
    { id:'pequeno', label:'Pequeno', icon:'🐭' },
    { id:'bom', label:'Bom', icon:'🌟' },
    { id:'ruim', label:'Ruim', icon:'👎' },
    { id:'vermelho', label:'Vermelho', icon:'🔴' },
    { id:'verde', label:'Verde', icon:'🟢' },
    { id:'azul', label:'Azul', icon:'🔵' },
    { id:'amarelo', label:'Amarelo', icon:'🟡' },
    { id:'num1', label:'1', icon:'1️⃣' },
    { id:'num2', label:'2', icon:'2️⃣' },
    { id:'num3', label:'3', icon:'3️⃣' },
    { id:'num4', label:'4', icon:'4️⃣' },
    { id:'num5', label:'5', icon:'5️⃣' },
  ]},
  { id:'questions', label:'Perguntas', icon:'❓', items:[
    { id:'o_que', label:'O que?', icon:'❓' },
    { id:'onde', label:'Onde?', icon:'📍' },
    { id:'quem', label:'Quem?', icon:'👤' },
    { id:'por_que', label:'Por quê?', icon:'❔' },
    { id:'como', label:'Como?', icon:'⚙️' },
  ]}
];
